...
@section('content')
    <div class="container">
        <div class="col bg-white" style="border: solid 2px #eee; padding: 20px">
            <div id="inputResult">
                <div class="row mb-4">
                    <div class="col">
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <div class="descr">
                            ...
                            данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">Фомин Владислав Анатольевич</span> (далее&nbsp;— Оператор).
                        </div>
                        <div class="ol">
                            <div class="li">
                            ...
                            <div class="li">
                                ...
                                которую Оператор может получить о&nbsp;посетителях веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://feedyou.ru</span>.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="ol">
                            ...
                            <div class="li">
                                ...
                                их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://feedyou.ru</span>.
                            </div>
                            <div class="li">
                            ...
                            <div class="li">2.8. Персональные данные&nbsp;— любая информация,
                                ...
                                Пользователю веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://feedyou.ru</span>.
                            </div>
                            <div class="li">
                            ...
                            <div class="li">
                                2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://feedyou.ru</span>.
                            </div>
                            <div class="li">
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <div class="ol">
                            <div class="li" id="GLkEIK6jR">
                                <table class="purpose-table">
                                    <tbody><tr>
                                        <th>Цель обработки</th>
                                        <td class="purpose-field"><span class="mark link">улучшение пользовательского опыта посетителей сайта а так же анализ посещений с целью выявления статистики и закономерностей с импользованием Яндекс-метрики</span></td>
                                    </tr>
                                    <tr>
                                        <th>Персональные данные</th>
                                        <td class="data-field"><ul><li><span class="mark link">данные о трафике (просмотры, визиты, посещаемость), информацию о пользователях (демографические данные, геолокация, возраст, пол, интересы), источники трафика (откуда пришли пользователи), поведение на сайте (время на сайте, глубина просмотра, отказы), технологические данные (операционная система, браузер, тип устройства), а также данные о коммерческих показателях (для интернет-магазинов) и техническую информацию о сайте (скорость загрузки страниц)</span></li></ul></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="types-field"><ul><li><span class="mark link">Сбор, запись, систематизация, накопление, хранение, уничтожение и&nbsp;обезличивание персональных данных</span></li><li><span class="mark link">Построение статистики и анализ поведения пользователей</span></li></ul></td>
                                    </tr>
                                    </tbody></table>
                    ...
                    <div class="col">
                        ...
                        <div class="ol">
                            ...
                            <div class="li">
                                ...
                                Оператору уведомление на&nbsp;адрес электронной почты Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">aravion1@yandex.ru</span>
                            ...
                            <div class="li">
                                ...
                                посредством электронной почты на&nbsp;электронный адрес Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">aravion1@yandex.ru</span>
                    ...
                    <div class="col">
                        ...
                        <div class="ol">
                            <div class="li">
                                ...
                                к&nbsp;Оператору с&nbsp;помощью электронной почты <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">aravion1@yandex.ru</span>.
                            </div>
                            <div class="li">
                            ...
                            <div class="li">
                                ...
                                в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">https://feedyou.ru/privacy/</span>.
                            </div>
                        </div>
                    </div>
                </div>
